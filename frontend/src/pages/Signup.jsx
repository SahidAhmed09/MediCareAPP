        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            focus:border-b-primaryColor text-[16px] leading-7 text-headingColor placeholder:text-textColor cursor-pointer"
              ...
              <div className="mb-5 flex items-center judtify-between">
            ...
            <div className="mb-5 flex items-center gap-3">
              <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center judtify-center">
